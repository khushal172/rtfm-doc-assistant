...
class GithubService:
    ...
    async def get_recursive_tree(self, owner: str, repo: str, branch: str = "main") -> List[Dict[str, Any]]:
        ...
        async with httpx.AsyncClient() as client:
            ...
            if response.status_code != 200:
                ...
                raise Exception(f"Failed to fetch repo tree: {response.status_code}")
